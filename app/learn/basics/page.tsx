...
export default function NetworkBasicsPage() {
  ...
  const checkIpAnswer3 = () => {
    if (ipAnswer3 === "b") {
      setIpFeedback3("正解です！ 👍")
      setProgress((prev) => Math.min(prev + 8.34, 100))
    } else {
